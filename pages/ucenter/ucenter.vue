<template>
	<view class="center">
		...
		<view class="userInfo" @click.capture="toUserInfo">
			<cloud-image radius="50%" width="120rpx" height="120rpx" v-if="userInfo.avatar_file&&userInfo.avatar_file.url" :src="userInfo.avatar_file.url"></cloud-image>
		...
		data() {
			return {
				...
				ucenterList: [
					[
						{
							"title": this.$t('mine.homePage'),
							"to": '/pages/ucenter/homePage/homePage',
							"icon": "home"
						},
						{
							"title": this.$t('mine.czAdmin'),
							"to": '/pages/ucenter/czAdmin/czAdmin',
							"icon": "gear"
						},
						// #ifdef APP-PLUS
						{
